...
- **Core stays small.** Everything that can be a plugin is a plugin. Core budget: ≤ 18 kB min+gzip. Each official plugin: ≤ 8 kB min+gzip (editor plugin exempt: ≤ 20 kB). Full bundle: ≤ 90 kB min+gzip. CI fails on budget breach.
